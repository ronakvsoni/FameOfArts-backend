...
image5 = Image.create(url: 'https://cdn.pixabay.com/photo/2013/01/05/21/02/mona-lisa-74050_1280.jpg', image_type: 'image', user: user1, artgallary: artgallary1, name: 'Classic!', description: 'We did so darn good you wouldnt believe omg we are awesome')
...
comment2 = Comment.create(comment_info: 'Krish: I want these painting', user: user2, image: image1)
